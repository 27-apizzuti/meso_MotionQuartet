...
for su in SUB:
    ...
    for hem in HEMI:
        ...
        ROI_LABEL = ['V1', 'hMT']
        rois_nii = nb.load(os.path.join(PATH_IN, 'derivatives', 'anat', '05_ROIseg', 'voronoi', ROIS_FILE))
        ...
        for it, roi in enumerate(ROI_LABEL):
            ...
            print('Save clusters')
            OUTPUTNAME = os.path.join(PATH_OUT, '{}_amb_maps_wholeBrain_bvbabel_res2x_float32_clusters_{}_{}.nii.gz'.format(su, hem, roi))
