...
mysub=sub-09
mydata=/mnt/d/Exp-MotionQuartet/MRI_MQ/BOLD/${mysub}/derivatives/func/sess-02/prf01/01_ANTS
myTarget=/mnt/d/Exp-MotionQuartet/MRI_MQ/BOLD/${mysub}/derivatives/func/sess-02/prf01/01_ANTS/${mysub}_sess-02_acq-mp2rage_UNI_denoised_IIHC_bvbabel_SSbet_BFC.nii.gz
mySource=/mnt/d/Exp-MotionQuartet/MRI_MQ/BOLD/${mysub}/derivatives/func/sess-02/prf01/01_ANTS/${mysub}_task-prf_acq-2depimb2_run-01_SCSTBL_3DMCTS_bvbabel_undist_reference_bvbabel.nii.gz

myITK=${mydata}/intial_affine.txt
...
antsApplyTransforms -d 3 -i ${mySource} -o ${mysub}_loc_anat_resliced_wb.nii.gz -r ${myTarget} -t ${mydata}/registered_1Warp.nii.gz -t ${mydata}/registered_0GenericAffine.mat
