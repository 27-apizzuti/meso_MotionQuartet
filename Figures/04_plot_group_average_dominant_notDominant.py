...
plt.tight_layout()
fig.savefig(os.path.join(OUTDIR, 'testtestROIwise_Figure_ERA_group_average_V1_hMT_dur_{}_{}_{}_dominant_notDominant'.format(DUR_MIN, DUR_MAX, STAT)), bbox_inches='tight')
